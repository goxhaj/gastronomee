...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.gastronomee.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.gastronomee.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(com.gastronomee.domain.User.class.getName() + ".authorities", jcacheConfiguration);
